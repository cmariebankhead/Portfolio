...
---------------------------------------------------*/	
	...
	function ContactMap() {	
		...
		if( jQuery('#map_canvas').length > 0 ){					
			...
			var settings = {
				zoom: 14,
				center: new google.maps.LatLng(43.1258437,-89.6168173),
			...
			var companyImage = new google.maps.AdvancedMarkerElement('images/marker.png',
				new google.maps.Size(58,63),<!-- Width and height of the marker -->
				new google.maps.Point(0,0),
				new google.maps.Point(35,20)<!-- Position of the marker -->
			);
			var companyPos = new google.maps.LatLng(43.1258437,-89.6168173);	
